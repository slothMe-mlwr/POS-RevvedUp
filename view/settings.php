    ...
    <div class="bg-white shadow-md rounded-2xl p-8 w-full max-w-md">
        ...
        <div class="tab-content" id="basic">
          ...
          <form id="frmUpdateBasicInfo" class="space-y-6">
              <!-- First Name -->
              <div>
                  <label for="nickname" class="block text-gray-700 mb-1 text-sm">Nickname</label>
                  <input type="text" id="nickname" name="nickname" value="<?=$On_Session['nickname']?>" 
                         class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:outline-none">
              </div>

              <!-- UserName -->
              <div>
                  <label for="username" class="block text-gray-700 mb-1 text-sm">Userrname</label>
        ...
        <p class="text-gray-500 mb-6 text-sm">Manage your login password.</p>
