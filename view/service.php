...
<div class="relative min-w-[250px]">
  <div class="flex gap-2 items-center">
    <input 
      ...
      class="serviceNameInput flex-1 border rounded px-3 py-2 text-sm focus:outline-none focus:ring focus:border-red-400"
    >
    <button id="addServiceBtn" class="cursor-pointer bg-gray-300 text-white px-3 py-2 rounded hover:bg-gray-400 transition flex items-center justify-center">
      <span class="material-icons text-gray-600 text-base">add</span>
    </button>
  </div>

  <!-- Dropdown -->
  <div class="serviceDropdown absolute z-50 w-full bg-white border rounded mt-1 max-h-48 overflow-y-auto hidden"></div>
</div>
  ...
  <div class="flex flex-wrap gap-2 justify-end">
    <a href="#"  
       class="btnRefundExchange font-bold flex items-center gap-2 bg-red-800 hover:bg-gray-300 hover:text-gray-600 transition text-white px-4 py-2 rounded text-sm whitespace-nowrap inline-block text-center shadow">
      REFUND | EXCHANGE
    </a>

    <a href="service" 
       class="flex items-center gap-2 bg-gray-300 text-gray-600 px-4 py-2 rounded border-black-300 text-sm font-bold shadow-sm">
      SERVICE
    </a>

    <a href="item" 
       class="font-bold flex items-center gap-2 bg-red-800 hover:bg-gray-300 hover:text-gray-600 transition text-white px-4 py-2 rounded text-sm whitespace-nowrap inline-block text-center shadow">
      ITEM
    </a>
  </div>
</header>
...
<section class="flex-1 flex flex-col px-4 py-3">
  ...
  <footer class="flex flex-col sm:flex-row gap-3 justify-between items-stretch sm:items-center bg-white border-t px-4 py-3">
    <!-- Proceed Button -->
    <button class="proceedToPayBtn cursor-pointer flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white px-5 py-2.5 rounded-lg shadow-md font-medium transition duration-200 ease-in-out w-full sm:w-auto">
      <span class="material-icons text-base">payment</span>
      Proceed to Payment
    </button>

    <!-- Total Box -->
    <div class="flex items-center gap-2 bg-gray-500 text-white px-6 py-2 rounded-lg font-semibold shadow text-center w-full sm:w-auto">
  ...
  <div id="transactionSidebar" 
    ...
    <div class="mt-5 flex gap-3">
      <button type="button" id="BtnSubmit" 
        class="flex-1 bg-green-500 text-white py-2 rounded hover:bg-green-600 transition cursor-pointer">
