...
<div id="ExchangeModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm" style="display: none;">
  <!-- Modal Content -->
  <div class="bg-white rounded-2xl shadow-xl w-full max-w-lg p-8 relative">
    ...
    <form method="GET" class="grid grid-cols-1 gap-6" >
      ...
      <div class="flex justify-between">
        <button type="submit" id="BtnFindRecord" formaction="exchange_sameItem" 
        ...
        <button type="submit" id="BtnFindRecord" formaction="exchange_newItem" 
                class="cursor-pointer bg-red-900 text-white py-2 px-6 rounded-xl hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-900 transition">
          New Item
        </button>
      </div>
...
<script src="../static/js/view/modal_exchange.js"></script>