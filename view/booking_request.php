...
<main class="flex-1 flex flex-col bg-gray-100 min-h-screen">
  ...
  <!-- Search Bar -->
<!-- Search + Filters -->
<div class="px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:space-x-4 gap-3">
  ...
  <!-- Date Sort -->
  <select id="dateSort" class="border px-3 py-2 rounded w-full sm:w-auto">
    <option value="upcoming">Upcoming First</option>
    <option value="all">All</option>
  </select>

  <!-- Status Filter -->
  <select id="statusFilter" class="border px-3 py-2 rounded w-full sm:w-auto">
