...
<header class="px-4 py-3 border-b bg-white flex flex-col gap-2">
 <div class="transaction-info flex justify-between text-sm text-gray-600">
  ...
  <div class="flex flex-wrap gap-2 justify-end">
    <a href="#" <?=$authorize?> 
       class="btnRefundExchange flex items-center gap-2 bg-gray-300 text-gray-600 px-4 py-2 rounded border-black-300 text-sm font-bold shadow-sm">
      REFUND | EXCHANGE
    </a>
...
<footer class="flex flex-col sm:flex-row gap-3 justify-between items-center bg-white border-t px-4 py-4">
  ...
  <div class="flex flex-col sm:flex-row gap-3 items-center">
    <button id="btnComplete_transaction" class=" bg-green-500 cursor-pointer hover:bg-green-600 text-white px-6 py-2 rounded shadow font-medium w-full sm:w-auto">
      Complete Transaction
    </button>
    <button class="bg-gray-500 cursor-pointer hover:bg-gray-400 text-white px-4 py-2 rounded shadow font-medium">
      Refund All
    </button>
    <button class="bg-gray-500 cursor-pointer hover:bg-gray-400 text-white px-4 py-2 rounded shadow font-medium">
      Exchange All
