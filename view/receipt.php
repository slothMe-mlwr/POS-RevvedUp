  ...
  <div class="print-container">
   ...
   <hr>
    ...
    <div class="flex" style="margin-bottom:5px;">
        ...
        <span>
            <?= htmlspecialchars(ucfirst($transaction['nickname'])) ?>
        </span>
    </div>
...
<div class="printButtonDiv"
  ...
  <button onclick="window.print()" class="btn-print" 
          style="display:flex; align-items:center; gap:8px; justify-content:center; padding:8px 14px; border:none; border-radius:6px; background:#444; color:white; cursor:pointer;">
      <span class="material-icons">print</span>
      Print Receipt
  </button>

  <button onclick="window.close()" class="btn-back"
          style="display:flex; align-items:center; gap:8px; justify-content:center; padding:8px 14px; border:none; border-radius:6px; background:#b91c1c; color:white; cursor:pointer;">
