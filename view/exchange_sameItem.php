...
<header class="bg-red-900 text-white flex items-center space-x-3 px-6 py-6">
    <h1 class="text-lg font-semibold">EXCHANGE SAME ITEM</h1>
</header>
...
<footer class="flex flex-col sm:flex-row gap-3 justify-between items-center bg-white border-t px-4 py-4">
  ...
  <div class="flex flex-col sm:flex-row gap-3 items-center">
    <button id="btnComplete_transaction" class=" bg-red-800 cursor-pointer hover:bg-red-700 text-white px-6 py-2 shadow font-medium w-full sm:w-auto">
...
<script src="../static/js/view/exchange_sameItem.js"></script>