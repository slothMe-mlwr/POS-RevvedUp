...
<div class="flex flex-col items-center justify-center flex-grow -mt-16"> 
  ...
  <div class="bg-transparent p-6 rounded-lg w-80">
      ...
      <form id="frmVerifyOTP" method="POST" class="flex flex-col space-y-4">
        <input type="text" placeholder="6-digit OTP" name="otp" class="px-4 py-2 rounded bg-white text-black placeholder-gray-500 focus:outline-none">
        <input type="password" placeholder="New Password" name="new_password" class="px-4 py-2 rounded bg-white text-black placeholder-gray-500 focus:outline-none">
        <button type="submit" id="btnLogin" class="bg-white cursor-pointer text-black font-semibold py-2 rounded hover:bg-gray-200">Verify & Reset Password</button>
      </form>
  </div>
</div>
</body>
