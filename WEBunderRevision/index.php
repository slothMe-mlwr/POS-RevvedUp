...
<section class="relative w-full h-screen" style="background-image: url('static/images/cover.jpg'); background-size: cover; background-position: center;">
  ...
  <div class="absolute inset-0 flex flex-col justify-center items-center text-center px-4 z-20">
    ...
    <div class="flex gap-6 mb-4">
      <a href="guest/index" class="bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-8 rounded-full transition">PRODUCTS</a>
    ...
    <section class="w-full py-16 bg-gray-900 text-white flex flex-col items-center">
      <h2 class="text-2xl font-bold mb-6">Trivia of the Day</h2>
        <p id="triviaText" class="text-center text-xl max-w-2xl px-6 italic opacity-0 transition-opacity duration-700">
          Loading trivia...
        </p>
    </section>
...
?>
<script src="static/js/get_trivia.js"></script>
