...
<div class="flex flex-col items-center justify-center flex-grow -mt-16"> 
  ...
  <div class="bg-transparent p-6 rounded-lg w-80">
      ...
      <form id="frmForgotPassword" method="POST" class="flex flex-col space-y-4">
        <input type="email" placeholder="you@example.com" name="email" class="px-4 py-2 rounded bg-white text-black placeholder-gray-500 focus:outline-none">
        <button type="submit" id="btnSendOTP" class="bg-white cursor-pointer text-black font-semibold py-2 rounded hover:bg-gray-200">Send OTP</button>
      </form>
  </div>
</div>
</body>
